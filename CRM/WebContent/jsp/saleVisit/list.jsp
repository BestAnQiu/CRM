										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>拜访时间：</TD>													
													<TD>
														<input type="text" name="visit_time" id="visit_time" value="<s:date name="visit_time" format="yyyy-MM-dd"/>">	
													</TD>	 	
													<TD>拜访结束时间：</TD>
													<TD>
														<input type="text" name="visit_end_time" id="visit_end_time" 
								...
								<TR>
									<TD><SPAN id=pagelink>
											<DIV style="LINE-HEIGHT: 20px; HEIGHT: 20px; TEXT-ALIGN: right">
												...
												,每页显示
												<select name="pageSize" onchang="to_page()">												
													<option value="3" <s:if test="pageSize==3">selected</s:if>>1</option>
