						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>
									...
									name="cust_name" value="<s:property value="cust_name"/>">
								</td>
							...
							<TR>
								...
								<td>固定电话 ：</td>
								<td>
								<INPUT class=textbox id=sChannel2 style="WIDTH: 180px" maxLength=50 name="cust_phone" value="<s:property value="cust_phone"/>">
								</td>
								<td>移动电话 ：</td>
								<td>
								<INPUT class=textbox id=sChannel2 style="WIDTH: 180px" maxLength=50 name="cust_mobile" value="<s:property value="cust_mobile"/>">
								</td>
							</TR>
							<TR>
								<td>公司资质：</td>
